...
// static_assert(GPIO_NUM_1 == halpp::SystemConfig::PIN_EXT1);
// static_assert(GPIO_NUM_2 == config::Audio::PIN_MCLK);  // I2S Master Clock (MCLK)
// static_assert(GPIO_NUM_3 == halpp::SystemConfig::PIN_EXT3);
...
// static_assert(GPIO_NUM_6 == halpp::SystemConfig::PIN_EXT6);
// static_assert(GPIO_NUM_7 == halpp::SystemConfig::PIN_EXT7);
...
// static_assert(GPIO_NUM_12 == halpp::SystemConfig::PIN_EXT12);
static_assert(GPIO_NUM_13 == config::Buzzer::PIN_PWM);  // Passive Buzzer PWM output
// static_assert(GPIO_NUM_14 == halpp::SDCardConfig::PIN_CLK);
// static_assert(GPIO_NUM_15 == config::Audio::PIN_AMP_ENABLE);
static_assert(GPIO_NUM_16 == config::TempDht11::PIN_DATA);  // DHT11 Data Pin
// static_assert(GPIO_NUM_17 == halpp::SDCardConfig::PIN_CMD);
// static_assert(GPIO_NUM_18 == halpp::LCDConfig::PIN_TE);
static_assert(GPIO_NUM_19 == config::Usb::PIN_USB_DM);
static_assert(GPIO_NUM_20 == config::Usb::PIN_USB_DP);
// static_assert(GPIO_NUM_21 == halpp::LCDConfig::PIN_CS);
// static_assert(GPIO_NUM_33 == halpp::SystemConfig::PIN_HDR_33);
// static_assert(GPIO_NUM_34 == halpp::SystemConfig::PIN_HDR_34);
// static_assert(GPIO_NUM_35 == halpp::SystemConfig::PIN_HDR_35);
// static_assert(GPIO_NUM_36 == halpp::SystemConfig::PIN_HDR_36);
// static_assert(GPIO_NUM_37 == halpp::SystemConfig::PIN_HDR_37);
// static_assert(GPIO_NUM_38 == config::Audio::PIN_WS);
// static_assert(GPIO_NUM_39 == config::Audio::PIN_DATA_IN);
// static_assert(GPIO_NUM_40 == halpp::LCDConfig::PIN_SCK);
// static_assert(GPIO_NUM_41 == halpp::LCDConfig::PIN_SDA0);
// static_assert(GPIO_NUM_42 == halpp::LCDConfig::PIN_SDA2);
...
// static_assert(GPIO_NUM_46 == halpp::LCDConfig::PIN_SDA3);
